<?php
/**
 * Home Section - Dynamic Latest Posts (text side)
 ...
 * - exclude  -> array of post IDs to skip
 */
...
$exclude = array_values(array_filter(array_map('absint', (array) $exclude)));
                ...
                <div class="lca-primary-column margin-bottom">
                    ...
                    if ($latest_posts->have_posts()):
                        ...
                        while ($latest_posts->have_posts()):
                            ...
                            get_template_part('template-parts/content-text-side', get_post_type());
                        endwhile;
